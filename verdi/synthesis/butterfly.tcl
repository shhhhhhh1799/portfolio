...
#set designName "butterfly_0"
set designName "fft_top"
#set revName     "rrc_pipe_filter1_0"
set revName "butterfly_final"
set outputName "${revName}"
set file_script  "butterfly.tcl"
set file_sdc_input "butterfly.sdc"
set file_hdl_list "butterfly.list"
